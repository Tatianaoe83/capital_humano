    ...
    <div class="space-y-4">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div class="sm:col-span-2">
                ...
                <x-text-input id="apellido_paterno" name="apellido_paterno" type="text" :value="old('apellido_paterno', $empleado?->apellido_paterno)" required />
            ...
            <div>
                ...
                <x-text-input id="apellido_materno" name="apellido_materno" type="text" :value="old('apellido_materno', $empleado?->apellido_materno)" />
            </div>
            <div>
                <x-input-label for="nombre" :value="__('Nombre(s)')" />
                <x-text-input id="nombre" name="nombre" type="text" :value="old('nombre', $empleado?->nombre)" required />
                <x-input-error :messages="$errors->get('nombre')" class="mt-1" />
            </div>
            <div>
                <x-input-label for="fecha_nacimiento" :value="__('Fecha de nacimiento')" />
                <x-text-input id="fecha_nacimiento" name="fecha_nacimiento" type="date" :value="old('fecha_nacimiento', $empleado?->fecha_nacimiento?->format('Y-m-d'))" />
            </div>
            <div>
                <x-input-label for="sexo" :value="__('Sexo')" />
                <select id="sexo" name="sexo" class="block mt-1 w-full rounded-md border-gray-300 shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
            ...
            <div>
                ...
                <select id="estado_civil" name="estado_civil" class="block mt-1 w-full rounded-md border-gray-300 shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
                    <option value="">{{ __('Seleccione...') }}</option>
            ...
            <div>
                ...
                <x-text-input id="hijos" name="hijos" type="number" min="0" :value="old('hijos', $empleado?->hijos ?? 0)" />
            </div>
        </div>
    </div>
    ...
    <div class="space-y-4">
        ...
        <div class="space-y-4">
            ...
            <div>
                ...
                <select id="jefe_inmediato_id" name="jefe_inmediato_id" class="block mt-1 w-full rounded-md border-gray-300 shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
                    <option value="">{{ __('Seleccione...') }}</option>
            ...
            <div>
                ...
                <x-text-input id="tipo_prestacion" name="tipo_prestacion" type="text" :value="old('tipo_prestacion', $empleado?->tipo_prestacion)" />
            </div>
            <div>
                <x-input-label for="personal" :value="__('Personal (Fijo/Eventual)')" />
                <select id="personal" name="personal" class="block mt-1 w-full rounded-md border-gray-300 shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
                    <option value="">{{ __('Seleccione...') }}</option>
            ...
            <div>
                ...
                <x-text-input id="tipo_contrato" name="tipo_contrato" type="text" :value="old('tipo_contrato', $empleado?->tipo_contrato)" />
            </div>
            <div>
                <x-input-label for="ubicacion" :value="__('Ubicación')" />
                <x-text-input id="ubicacion" name="ubicacion" type="text" :value="old('ubicacion', $empleado?->ubicacion)" />
            </div>
        </div>
    </div>
</div>
...
<div class="mt-6 space-y-4">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <div>
            ...
            <x-text-input id="curp" name="curp" type="text" maxlength="18" :value="old('curp', $empleado?->curp)" />
        </div>
        <div>
            <x-input-label for="nss" :value="__('NSS')" />
            <x-text-input id="nss" name="nss" type="text" :value="old('nss', $empleado?->nss)" />
        </div>
        <div>
            <x-input-label for="rfc" :value="__('RFC')" />
            <x-text-input id="rfc" name="rfc" type="text" maxlength="13" :value="old('rfc', $empleado?->rfc)" />
        </div>
        <div>
            <x-input-label for="registro_patronal" :value="__('Registro patronal')" />
            <x-text-input id="registro_patronal" name="registro_patronal" type="text" :value="old('registro_patronal', $empleado?->registro_patronal)" />
        </div>
    </div>
</div>
...
<div class="mt-6 space-y-4">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        <div>
            ...
            <x-text-input id="telefono" name="telefono" type="text" :value="old('telefono', $empleado?->telefono)" />
        </div>
        <div>
            <x-input-label for="numero_contacto" :value="__('Número de contacto')" />
            <x-text-input id="numero_contacto" name="numero_contacto" type="text" :value="old('numero_contacto', $empleado?->numero_contacto)" />
        </div>
        <div class="sm:col-span-2 lg:col-span-1">
            <x-input-label for="correo_personal" :value="__('Correo personal')" />
            <x-text-input id="correo_personal" name="correo_personal" type="email" :value="old('correo_personal', $empleado?->correo_personal)" />
        </div>
        <div>
            <x-input-label for="correo_institucional" :value="__('Correo institucional')" />
            <x-text-input id="correo_institucional" name="correo_institucional" type="email" :value="old('correo_institucional', $empleado?->correo_institucional)" />
        </div>
        <div class="sm:col-span-2">
            <x-input-label for="domicilio" :value="__('Domicilio')" />
            <textarea id="domicilio" name="domicilio" rows="2" class="block mt-1 w-full rounded-md border-gray-300 shadow-sm focus:ring-indigo-500 focus:border-indigo-500">{{ old('domicilio', $empleado?->domicilio) }}</textarea>
        </div>
    </div>
</div>
